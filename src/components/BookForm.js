...
function BookForm() {
  return (
    ...
    <label html='book_title' >Book Title</label>
    </div>

    <div className='input-field col s6'>
    <input id='book_author' type="text" className='validate'/>
    <label html='book_author' >Book Author</label>
    </div>
    </div>
    ...
    <label html='book_category' >Book category</label>
    </div>

    <div className='input-field col s6'>
    <input id='book_isbn' type="text" className='validate'/>
    <label html='book_isbn' >Book ISBN</label>
    </div>
    </div>
